navigator.geolocation.getCurrentPosition(
  (position) => {
    ...
    fetch(
      `https://api.geoapify.com/v1/geocode/reverse?lat=${latitude}&lon=${longitude}&apiKey=b221aa5cf471413f9671db116797d760`,
      requestOptions
    )
...
function getLocationInfo() {
  ...
  fetch(
    `https://api.geoapify.com/v1/geocode/search?text=${city}&apiKey=b221aa5cf471413f9671db116797d760`,
    requestOptions
  )
    .then((response) => response.json())
    .then((data) => {
